...
const AboutDetails = () => {
  return (
    <div className='text-white bg-[#020415]'>
        <div className='max-w-[1200px] mx-auto lg:flex gap-10 items-center py-20 px-10 lg:px-0 space-y-10 lg:space-y-0'>
            ...
            <div className="w-full lg:w-[540px] space-y-5">
                ...
                <h2 className='text-[30px] lg:text-[40px]'>We built Crypto platform to buy & sell shares.</h2>
