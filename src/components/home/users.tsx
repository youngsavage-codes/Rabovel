...
const Users = () => {
  return (
    <div className='text-white bg-[#020415]'>
      <div className='w-full lg:max-w-[1200px] mx-auto space-y-10 py-20 px-10 lg:flex gap-10 items-center'>
        ...
        <div className="w-full lg:w-[540px] space-y-5">
          ...
          <Button className='bg-[#745CEC] text-lg p-8 rounded-full'>Learn More</Button>
        </div>
      </div>
    </div>
  )
